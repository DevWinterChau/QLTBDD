...
namespace DongHoShop.Areas.Admin.Controllers
{
    ...
    public class SanPhamController : Controller
    {
        ...
        public SanPhamController(DongHoShopContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("ID,HangSanXuatID,LoaiSanPhamID,TenSanPham,DonGia,SoLuong,DuLieuHinhAnh,MoTa")] SanPham sanPham)
        {
            ...
            {
                string path = "Server=DESKTOP-VPSR0NB\\\\SQLEXPRESS;Database=DHShop;Integrated Security=True;MultipleActiveResultSets=True;TrustServerCertificate=True";
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DongHoShopContext.SanPham'  is null.");
            }
            var sanPham = await _context.SanPham.FindAsync(id);
            if (sanPham != null)
            {
