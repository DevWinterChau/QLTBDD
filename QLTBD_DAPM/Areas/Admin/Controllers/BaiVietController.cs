...
namespace ITShop.Areas.Admin.Controllers
{
    ...
    public class BaiVietController : Controller
    {
        ...
        {
            if (id == null || _context.BaiViet == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.BaiViet == null)
            {
                return Problem("Entity set 'ITShopDbContext.BaiViet'  is null.");
            }
            var baiViet = await _context.BaiViet.FindAsync(id);
            if (baiViet != null)
            {
        ...
        {
            return (_context.BaiViet?.Any(e => e.ID == id)).GetValueOrDefault();
        }
    }
}